...
npx cypress run --spec "cypress/e2e/OE/NewListingFlow/ListSpaceBackNav.cy.js" --browser chrome --record --key f2351ad0-639d-413a-890a-73a36ee4d09c --config viewportWidth=375,viewportHeight=677 --tag "Create space full flow [MOBILE]"
...
npx cypress run --spec "cypress/e2e/OE/NewListingFlow/ListSpaceBackNav.cy.js" --browser chrome --record --key f2351ad0-639d-413a-890a-73a36ee4d09c --config viewportWidth=1980,viewportHeight=1024 --tag "Create space full flow [DESKTOP]"
