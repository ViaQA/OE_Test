...
describe('Check Sign up form', () => {
    ...
    it( "Test sign up empty validation", ()=>{
        ...
        cy.xpath('//input[@data_atr="signUpEmail"]/following-sibling::div').should('have.text', 'Email is a required field')
    ...
    it( "Test sign up must be at least 2 chracters", ()=>{
        ...
        cy.xpath('//input[@data_atr="signUpEmail"]/following-sibling::div').should('have.text', 'Email must be a valid email')
