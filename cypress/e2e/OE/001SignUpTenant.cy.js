...
describe('Check Sign up form', () => {
    ...
    it( "Test sign up empty validation", ()=>{
        ...
        cy.get('[data_atr="signUp-email"]').click()
        ...
        cy.xpath('//input[@data_atr="signUp-email"]/following-sibling::div').should('have.text', 'Email is a required field')
    ...
    it( "Test sign up must be at least 2 chracters", ()=>{
        ...
        cy.get('[data_atr="signUp-email"]').type("q")
        ...
        cy.xpath('//input[@data_atr="signUp-email"]/following-sibling::div').should('have.text', 'Email must be a valid email')
    ...
    it("Test type valid data", ()=>{
        ...
        cy.get('[data_atr="signUp-email"]').type(creds_tenant.email_tenant)
