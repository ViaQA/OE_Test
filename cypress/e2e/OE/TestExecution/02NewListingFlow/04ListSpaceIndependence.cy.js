...
describe('Check list space flow', () => {
    ...
    it('Create meeting Step 3 time for Availability ', () => {
        ...
        cy.get('[data-qa="hour_start"]').type('12')
        cy.get('[data_atr="time24Hour"]').should('have.css','border', signup_css.border_grey2px)
        cy.get('[data-qa="hour_end"]').type('12')

        //cy.get('[data-qa="hour_start"]').should('have.css', 'border', signup_css.border_darkblue)
        //cy.get('[data-qa="hour_end"]').should('have.css', 'border', signup_css.border_darkblue)
        ...
        cy.get('[data-qa="hour_start"]').type('1011')
        cy.get('[data-qa="hour_start"]').should('have.value', listData.custom_start_time)
        cy.get('[data-qa="hour_end"]').type('0222')
        cy.get('[data-qa="hour_end"]').should('have.value', listData.custom_end_time)

        //verify err message
        //cy.get('[data-qa="hour_start"]').should('have.css','border', err_css.err_border)
        //cy.get('[data-qa="hour_end"]').should('have.css','border', err_css.err_border)
